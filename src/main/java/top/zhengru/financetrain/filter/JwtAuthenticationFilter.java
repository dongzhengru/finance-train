package top.zhengru.financetrain.filter;
...
import top.zhengru.financetrain.service.impl.GrantedAuthorityImpl;
import top.zhengru.financetrain.service.impl.UserDetailImpl;
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (Objects.nonNull(token) && !token.trim().isEmpty()){
            ...
            if (!Objects.isNull(claims)){
                ...
                UserDetailImpl userDetail = new UserDetailImpl(username, null, roles, grantedAuthoritiesImpl);
                //交还给SpringSecurity
